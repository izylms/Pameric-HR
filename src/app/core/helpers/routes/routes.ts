...
export class routes {
  ...
  public static get company_page(): string {
    return this.baseUrl + '/company/company-page';
  }
  ...
  public static employeeprofile(empId: number): string {
    return `${this.baseUrl}/employees/employee-profile/${empId}`;
  }
